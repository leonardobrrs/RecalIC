                ...
                <div class="card-body p-4 p-md-5"> 
                    ...
                    <form action="{{ url('/admin/login') }}" method="POST">
                        ...
                        <div class="d-flex flex-column flex-sm-row justify-content-between gap-2">
                            <a href="{{ url('/') }}" class="btn btn-outline-secondary"><i class="bi bi-person"></i> Entrar como Usuário</a>
                            <a href="{{ url('/admin/cadastro') }}" class="btn btn-outline-dark"><i class="bi bi-person-plus"></i> Criar Conta</a>
                        </div>
                    </form>
                </div>
            </div>
